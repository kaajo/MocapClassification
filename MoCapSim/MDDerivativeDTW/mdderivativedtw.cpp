...
float MDDerivativeDTW::getDistance(MocapAnimation &anim1, MocapAnimation &anim2)
{
    ...
    {
        const float res = computeDistOpt(anim1, anim2,m_descriptors[anim1.getId()],m_descriptors[anim2.getId()]);
